# -*- coding: utf-8 -*-
#
# Aesel documentation build configuration file, created by
# sphinx-quickstart on Tue Jul  4 03:42:44 2017.
#
...
latex_documents = [
    (master_doc, 'Aesel.tex', u'Aesel Documentation',
     u'AO', 'manual'),
]
...
man_pages = [
    (master_doc, 'aesel', u'Aesel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Aesel', u'Aesel Documentation',
     author, 'Aesel', 'One line description of project.',
     'Miscellaneous'),
]
